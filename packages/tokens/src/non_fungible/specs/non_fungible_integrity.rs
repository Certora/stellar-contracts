...
#[rule]
// after transfer the token owner is set to the to address and balances are
// updated correctly status: verified
...
#[rule]
// after transfer_from the token owner is set to the to address, balances are
// updated correctly and approval is removed
// status: verified
