...
use crate::rwa::{
    identity_claims::storage::{
        ...
        Claim, ClaimsStorageKey,
    },
    specs::{helpers::clogs::clog_vec_bytes_n, mocks::claim_issuer_trivial::try_is_claim_valid},
};
...
// invariant: get_claim doesn't panic -> get_claims_by_topic doesn't panic &
// claim in claims
...
// invariant: get_claims_by_topic includes claim_id -> get_claim for claim_id
// does not panic
