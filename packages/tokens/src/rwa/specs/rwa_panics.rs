...
use crate::{
    ...
    rwa::{
        ...
        specs::mocks::{
            compliance_trivial::ComplianceTrivial,
            identity_verifier_trivial::IdentityVerifierTrivial,
        },
        RWA,
    },
};
...
pub fn assume_verify_identity_result_map_is_uninit() {
    use crate::rwa::specs::{
        helpers::ghosts::GhostMap::UnInit,
        mocks::identity_verifier_trivial::VERIFY_IDENTITY_RESULT_MAP,
    };
    unsafe {
        let verify_identity_result_map: &crate::rwa::specs::helpers::ghosts::GhostMap<
            Address,
            bool,
        > = &VERIFY_IDENTITY_RESULT_MAP;
