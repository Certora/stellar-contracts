...
use crate::rwa::{
    claim_topics_and_issuers::{
        storage::{
            ...
            get_trusted_issuer_claim_topics, get_trusted_issuers, has_claim_topic,
            is_trusted_issuer, remove_claim_topic, remove_trusted_issuer,
            update_issuer_claim_topics,
        },
        ClaimTopicsAndIssuers,
    },
    specs::helpers::{
        clogs::{clog_vec, clog_vec_addresses},
        nondet::nondet_vec_u32,
    },
};
...
#[rule]
// after add_claim_topic the claim_topic is not in
// get_trusted_issuer_claim_topics(issuer) for any issuer status: verified
...
// invariant: topic in get_trusted_issuer_claim_topics(issuer) -> topic in
// get_claim_topics()
