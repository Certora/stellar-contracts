...
SOURCES = ["contract-utils/src/**/*.rs"]
EXECUTABLES = "../target/wasm32-unknown-unknown/release/stellar_contract_utils.wasm"
...
def main():
    ...
    parser.add_argument(
        "-l", "--log", action="store_true", help="Show log outputs from cargo build on standard out."
    )
