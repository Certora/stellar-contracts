...
// description: 1. threshold != 0 and 2. threshold <= ctx_rule.signers.len(),
// note: the second invariant may be violated by the smart_account by removing
// signers. status: verified
